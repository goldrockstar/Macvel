  ...
  return (
    <div className='servicedetails-page'>
      ...
      <div className='servicedetails'>
        <h2 className='serviceshead'>{ServicesData.servicesDetails}</h2>
      </div>

      {/* section1 */}
      <div className='section-details'>
      <div className='heroinner-main'>
          <h2 className='h2-sd'>{ServicesData.main}</h2>
          <p className='p-sd'>{ServicesData.mainsub}</p>
        </div>

        <div className='section1-sd'>
            ...
            <SwiperSlide>
              <div className='swiper-content landscape'>
                ...
                <h3 className='serhead'>{ServicesData.servicesDetails1}</h3>
                  ...
                  <p className='lp-sd'>{ServicesData.sectionsd4}</p>
            ...
            <SwiperSlide>
              <div className='swiper-content landscape'>
                ...
                <h3 className='serhead'>{ServicesData.servicesDetails2}</h3>
                  ...
                  <p className='lp-sd'>{ServicesData.sectionea4}</p>
            ...
            <SwiperSlide>
              <div className='swiper-content stact'>
                ...
                <h3 className='serhead'>{ServicesData.servicesDetails3}</h3>
                  ...
                  <p className='lp-sd'>{ServicesData.sectionda3}</p>
            ...
            <SwiperSlide>
              <div className='swiper-content stact'>
                ...
                <h3 className='serhead'>{ServicesData.servicesDetails4}</h3>
                  ...
                  <p className='lp-sd'>{ServicesData.sectionseo3}</p>
            ...
            <SwiperSlide>
              <div className='swiper-content stact'>
                ...
                <h3 className='serhead'>{ServicesData.servicesDetails5}</h3>
                  ...
                  <p className='lp-sd'>{ServicesData.sectionwm3}</p>
            ...
            <SwiperSlide>
              <div className='swiper-content stact'>
                ...
                <h3 className='serhead'>{ServicesData.servicesDetails6}</h3>
                  ...
                  <p className='lp-sd'>{ServicesData.sectionca4}</p>
      ...
      {/* section2 */}
      <div className='section2-summary'>
        <h2>{ServicesData.heading}</h2>
        <p className='para-sd'>{ServicesData.intro}</p>
   <div className='section2-sd'>
    <div className='dropdown'>
  <div className="dropdown-container">
    <button className="dropdown-button">{ServicesData.servicedetailhead}</button>
    <div className="content1-sd">
        ...
        >
          <SwiperSlide>
            <div className="webdetails">
              ...
              <p className='wdlist'><i class="fas fa-dot-circle"></i>{ServicesData.wdlist}</p>
              <p className='wdlist'><i class="fas fa-dot-circle"></i>{ServicesData.wdlist1}</p>
              <p className='wdlist'><i class="fas fa-dot-circle"></i>{ServicesData.wdlist2}</p>
              <p className='wdlist'><i class="fas fa-dot-circle"></i>{ServicesData.wdlist3}</p>
            </div>
          </SwiperSlide>
    ...
    <button className="dropdown-button"  >{ServicesData.servicedetail1}</button>
    <div className="content1-sd">
        ...
        >
          <SwiperSlide>
            <div className="webdetails">
              <h5 className="wdhead">{ServicesData.wdhead}</h5>
              <p>{ServicesData.processoverview}</p>
              <p className='wdlist'><i class="fas fa-dot-circle"></i>{ServicesData.malist}</p>
              <p className='wdlist'><i class="fas fa-dot-circle"></i>{ServicesData.malist1}</p>
              <p className='wdlist'><i class="fas fa-dot-circle"></i>{ServicesData.malist2}</p>
            </div>
          </SwiperSlide>
    ...
    <button className="dropdown-button"  >{ServicesData.servicedetail2}</button>
     <div className="content1-sd">
        ...
        >
          <SwiperSlide>
            <div className="webdetails">
              <h5 className="wdhead">{ServicesData.wdhead}</h5>
              <p >{ServicesData.processoverview}</p>
              <p className='wdlist'><i class="fas fa-dot-circle"></i>{ServicesData.wbscontent}</p>
              <p className='wdlist'><i class="fas fa-dot-circle"></i>{ServicesData.wbscontent1}</p>
              <p className='wdlist'><i class="fas fa-dot-circle"></i>{ServicesData.wbscontent2}</p>
              <p className='wdlist'><i class="fas fa-dot-circle"></i>{ServicesData.wbscontent3}</p>
            </div>
          </SwiperSlide>
